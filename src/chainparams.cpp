...
{
    const char* pszTimestamp = "04/Jul/2017 Declaration of Independence was adopted 241 years ago on July 4, 1776";
    const CScript genesisOutputScript = CScript() << ParseHex("420840710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 10 * 60; // 6 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1499126400; // July 4, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1517356801; // January 31st, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1499126400; // July 4, 2017
        ...
        consensus.defaultAssumeValid = uint256S("0x"); //1155631
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x"); //8711
        ...
        //vSeeds.push_back(CDNSSeedData("hashcointools.com", "testnet-seed.hashcointools.com"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1499126400, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));
