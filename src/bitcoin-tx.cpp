...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hashcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hashcoin transaction") + "\n" +
              "  hashcoin-tx [options] -create [commands]   " + _("Create hex-encoded hashcoin transaction") + "\n" +
              "\n";
