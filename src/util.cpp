...
const char * const BITCOIN_CONF_FILENAME = "hashcoin.conf";
const char * const BITCOIN_PID_FILENAME = "hashcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hashcoin";
#else
    // Unix
