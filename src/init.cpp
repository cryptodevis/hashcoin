...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hashcoin-project/hashcoin>";
    const std::string URL_WEBSITE = "<https://hashcoin.org>";
